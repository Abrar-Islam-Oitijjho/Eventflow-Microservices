...
EventFlow is a small, production-style project (demo) that shows:
...
<img src="docs/architecture_v2.png">
...
- **Event timeline plot**:
<img src="docs/event_timeline.png">

- **Sample run log screenshot**: `docs/sample_run_logs.png`
<img src="docs/sample_run_logs.png">
